...
# 7) В Java концепции **"pass by value"** и **"pass by reference"** объясняют, как аргументы передаются в методы. Java **всегда** использует **"pass by value"**, но важно понимать, что это означает для примитивных типов и объектов.
